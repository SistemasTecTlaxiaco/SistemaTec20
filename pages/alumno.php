...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from usuario where tipo='estudiante'")or die(mysqli_error());
    $i=0;
...
<td><?php echo $row['usuario'];?></td>
  <td><?php echo $row['tipo'];?></td>      
    <td><?php echo $row['correo'];?></td>                                      
                      ...
                      ?>
  <a class="small-box-footer btn-print"  href="<?php  echo "eliminar_alumno.php?cid=$cid";?>"><i class="glyphicon glyphicon-remove"></i></a>
  <a class="small-box-footer btn-print"  href="<?php  echo "editar_password.php?cid=$cid";?>"><i class="glyphicon glyphicon-eye-open"></i></a>     
<a class="btn btn-danger btn-print" href="<?php  echo "editar_alumno.php?cid=$cid";?>"  role="button">Editar</a>
             <?php
            //          }
                      ?>
